...
// Metadata is moved to a separate file or handled differently (see below)
export default function GlobalGroupSettingsPage() {
          ...
          <section className="rounded-xl border border-gray-200 p-6 shadow-sm transition hover:shadow-md dark:border-gray-700 dark:bg-gray-800/50">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <label className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-700/50">
                ...
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">Public (Anyone can find and join)</span>
              </label>
              <label className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-700/50">
                <input
                  type="radio"
                  ...
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">Private (Invite or approval required)</span>
              </label>
            </div>
          </section>
          ...
          <section className="rounded-xl border border-gray-200 p-6 shadow-sm transition hover:shadow-md dark:border-gray-700 dark:bg-gray-800/50">
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
              <label className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-700/50">
                ...
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">Allow Images</span>
              </label>
              <label className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-700/50">
                <input
                  type="checkbox"
                  ...
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded dark:bg-gray-700 dark:border-gray-600"
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">Allow Videos</span>
              </label>
              <label className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-700/50">
                <input
                  type="checkbox"
                  ...
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded dark:bg-gray-700 dark:border-gray-600"
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">Allow Documents</span>
              </label>
              <label className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-700/50">
                <input
                  type="checkbox"
                  ...
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded dark:bg-gray-700 dark:border-gray-600"
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">Auto-delete media after 30 days</span>
              </label>
            </div>
          </section>
